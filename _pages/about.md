...
平岡 達也 (Hiraoka, Tatsuya) is a researcher in natural language processing, focusing on tokenization and interpretability. His research explores the nature of language as viewed through machine learning models, asking what linguistic structure emerges within them and how it relates to human language.

## Current Positions
- **Postdoctoral Associate** at [MBZUAI](https://mbzuai.ac.ae/), [MINT Team](https://www.mint-nlp-mbzuai.com/)
- **Visiting Scientist** at [RIKEN](https://www.riken.jp/en/), [Natural Language Understanding Team](https://www.riken.jp/en/research/labs/aip/goalorient_tech/nat_lang_understand/index.html)
- **Visiting Assistant Professor** at [NAIST](https://www.naist.jp/en/), [Watanabe Lab](https://nlp.naist.jp/en/)
...
## Teaching Experience
### Part-time Lecturer
- 2024: オブジェクト指向プログラミング / Object Oriented Programming
...
### Teaching Assistant
- 2024: NLP701/805 Natural Language Processing
  - Mohamed bin Zayed University of Artificial Intelligence
- 2019: 機械学習 / Machine Learning
  - 東京工業大学 / Tokyo Institute of Technology
- 2018: 自然言語処理 / Natural Language Processing
